...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="bg-white rounded-xl border p-5 mb-6">
        ...
        <div class="space-y-3">
            @foreach($order->items as $item)
                <div class="flex gap-3 py-2 border-b last:border-b-0">
                    @if($item->product)
        ...
        <div class="mt-4 space-y-1 text-sm text-gray-600">
            ...
            <div class="flex justify-between font-bold text-gray-900 border-t pt-2 mt-2 text-base"><span>Total</span><span class="text-primary">{{ $symbol }}{{ number_format($order->total, 0) }}</span></div>
        </div>
    </div>
    ...
    @if($order->statusHistories->isNotEmpty())
        <div class="bg-white rounded-xl border p-5">
            <h3 class="font-semibold text-gray-700 mb-4">Order Timeline</h3>
            <div class="space-y-3">
