            ...
            <form action="{{ route('customer.verify-otp') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="otp" required maxlength="6" pattern="[0-9]{6}"
                           ...
                           class="w-full border border-gray-300 rounded-xl px-4 py-3 text-center text-2xl font-bold tracking-widest focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 @error('otp') border-red-400 @enderror">
