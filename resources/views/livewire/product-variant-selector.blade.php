...
<div>
    ...
    <div class="flex items-center gap-3">
        <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
            <button wire:click="decrement" class="px-3 py-2 text-gray-600 hover:bg-gray-100">−</button>
            <span class="px-4 py-2 text-sm font-medium border-x border-gray-300">{{ $quantity }}</span>
            <button wire:click="increment" class="px-3 py-2 text-gray-600 hover:bg-gray-100">+</button>
        </div>
